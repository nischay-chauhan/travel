    ...
    >
      <div className="relative">
        <div className="relative overflow-hidden rounded-t-2xl aspect-square">
          ...
          <button
            className={`absolute top-4 right-4 rounded-full p-2 transition-colors duration-200 z-10 ${isLiked
          ...
          >
            <Heart
              className={`h-5 w-5 ${isLiked ? "fill-red-500" : "fill-transparent stroke-current"
                }`}
            />
